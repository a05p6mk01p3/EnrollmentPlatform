# Enrollment Platform — OpenAPI / Contract Draft v0.1.3

Status: **DRAFT TÉCNICO REVISADO — candidato a contract tests / codegen experimental**

Fonte normativa imediata: **Enrollment Protocol Specification v0.2.4**.

## Escopo da sincronização v0.1.3 (CR-M5.6-001)
...
3. **Sincronização de proveniência**:
   - Metadados de proveniência sincronizados para a Enrollment Protocol Specification v0.2.4 em todas as 21 operações e blocos de documentação.
