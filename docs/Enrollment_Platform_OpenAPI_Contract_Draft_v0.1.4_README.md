# Enrollment Platform — OpenAPI / Contract Draft v0.1.4

Status: **DRAFT TÉCNICO REVISADO — candidato a contract tests / codegen experimental**

Fonte normativa imediata: **Enrollment Protocol Specification v0.2.5**.

## Escopo da sincronização v0.1.4 (CR-M5.8-001)
...
3. **Sincronização de proveniência**:
   - Metadados de proveniência agora sincronizados para a Enrollment Protocol Specification v0.2.5 em todas as 21 operações e blocos de documentação.
